...
public class StringCalculatorMultiplicationTest {
	...
	public void should_return_0_on_empty_input() throws Exception {
		assertThat(new StringCalculator().multiply("")).isEqualTo(0);
	}
	...
	public void should_return_input_when_given_a_single_number(String input)
			throws Exception {
		assertThat(new StringCalculator().multiply(input)).isEqualTo(
	...
	public void should_return_sum_when_given_two_numbers(String input,
		...
		assertThat(new StringCalculator().multiply(input)).isEqualTo(expected);
	}
	...
	public void should_throw_exception_on_wrong_separations(String input) throws Exception {
		assertThat(new StringCalculator().multiply(input)).isNotNull();
	}
